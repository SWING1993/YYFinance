...
#define CHAT_BUTTON_SIZE CGSizeMake(50,50)
#define INSETS 10
...
@property (nonatomic, strong) QMUIButton *takePicButton;
...
- (void)setupSubviewsForType:(HDChatToolbarType)type
{
    ...
    _photoButton = [[QMUIButton alloc] init];
    _photoButton.imagePosition = QMUIButtonImagePositionTop;
    _photoButton.spacingBetweenImageAndTitle = 20;
    ...
    _photoButton.frame = CGRectMake(insets, 10, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height);
//    _photoButton = [self btnWithImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_colorMore_photo"]
//                    highlightedImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_colorMore_photoSelected"]
//                               title:@"照片"];
//    [_photoButton setFrame:CGRectMake(insets, 10, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height)];
    ...
    _takePicButton = [[QMUIButton alloc] init];
    _takePicButton.imagePosition = QMUIButtonImagePositionTop;
    _takePicButton.spacingBetweenImageAndTitle = 20;
    ...
    _takePicButton.frame = CGRectMake(insets * 2 + CHAT_BUTTON_SIZE.width, 10, CHAT_BUTTON_SIZE.width , CHAT_BUTTON_SIZE.height);
//    _takePicButton = [self btnWithImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_colorMore_camera"]
//                       highlightedImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_colorMore_cameraSelected"]
//                                  title:@"拍照"];
