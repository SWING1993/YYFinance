...
#define PinRecord NSLocalizedString(@"按住说话", @"hold down to talk")
#define EndOrSlide NSLocalizedString(@"向上取消发送", @"Release to end, finger up to cancel sending")
#define CancelRecord NSLocalizedString(@"松开手指，取消发送l", @"loosen the fingers, to cancel sending")
#define TimeIsTooShort NSLocalizedString(@"时间太短", @"record time too short")
#define NotStartedRecording NSLocalizedString(@"没有开始录制", @"Didn't start the recording")
