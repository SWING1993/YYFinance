...
- (void)setupBarButtonItem
{
    ...
    [backButton setTitle:NSLocalizedString(@"文本", @"Note") forState:UIControlStateNormal];
...
//    });
    ...
    commitLabel.text = NSLocalizedString(@"成功", @"Submit successful");
    ...
    thankLabel.text = NSLocalizedString(@"谢谢你的留言", @"Thank you for your leave message.");
    ...
    thankLabelOther.text = NSLocalizedString(@"我们会在第一时间给您回复。", @"We will give you a response at the first time.");
