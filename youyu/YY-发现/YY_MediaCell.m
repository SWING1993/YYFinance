...
@end
@implementation YY_MediaCell
static NSString * const identifier = @"YY_MediaCell";
- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    YY_MediaCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
...
- (void)bind:(NSDictionary *)obj {
    ...
    self.titleLabel.text = [obj.str(@"abstract")stringByReplacingOccurrencesOfString:@"&nbsp" withString:@""];
