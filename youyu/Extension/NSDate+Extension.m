...
//- (NSString *)apiformatYMD {
//    return [NSString stringWithFormat:@"%lu%02lu%02lu", (unsigned long)[self year],(unsigned long)[self month], (unsigned long)[self day]];
//}
...
- (NSString *)formatYMDHMLine {
    return [NSString stringWithFormat:@"%lu-%02lu-%02lu %02lu:%02lu:%02lu", (unsigned long)[self year],(unsigned long)[self month], (unsigned long)[self day],(unsigned long)[self hour],(unsigned long)[self minute],(unsigned long)[self seconds]];
}
...
- (NSString *)formatD:(NSString *)d H:(NSString *)h M:(NSString *)m S:(NSString *)s {
    return [NSString stringWithFormat:@"%02lu%@%02lu%@%02lu%@%02lu%@", (unsigned long)[self day], d,(unsigned long)[self hour],h,(unsigned long)[self minute], m,(unsigned long)[self seconds],s];
}
