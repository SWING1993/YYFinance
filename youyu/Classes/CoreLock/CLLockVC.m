...
-(void)vcPrepare{
    ...
    [self.iconImg sd_setImageWithURL:[NSURL URLWithString:[GVUserDefaults  shareInstance].app_litpic] placeholderImage:[UIImage imageNamed:@"icon_account_user"]];
