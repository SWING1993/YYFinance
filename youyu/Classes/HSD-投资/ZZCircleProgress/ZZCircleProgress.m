...
- (void)drawRect:(CGRect)rect {
    ...
    if (_showProgressText) {
        ...
        NSString *currentText = [NSString stringWithFormat:@"%.1f%%",fakeProgress*100];
        //段落格式
        ...
        //构建属性集合
        NSDictionary *attributes = @{NSFontAttributeName:font, NSParagraphStyleAttributeName:textStyle,NSForegroundColorAttributeName:MainColor};
        //获得size
